...
class LabelView extends Component {
  ...
  mouseDownHandler(event) {
    ...
    if (
      ...
      event.target.id !== "Crosshair") || this.props.committedBoxes.length > 0
    )
      return;
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <br></br>
          <div id="LabelView">
            {this.state.showCrosshair && this.isCrosshairReady() > 0 &&
              <Crosshair
                x={this.state.currX}
                y={this.state.currY}
          ...
          {this.props.showSidePanel &&
            <div id="SidePanel">
              <InfoPanel />
              <SubmitButtonContainer loadImageURL={this.props.loadImageURL} aid={this.props.aid}/>
            </div>
          }
